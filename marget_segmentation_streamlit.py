...
filename = r"C:\Users\arjun\PycharmProjects\pythonProject\market_segmentation.sav"
loaded_model = pickle.load(open(filename, 'rb'))
df = pd.read_csv(r"C:\Users\arjun\PycharmProjects\pythonProject\clustered_customer_data.csv")
